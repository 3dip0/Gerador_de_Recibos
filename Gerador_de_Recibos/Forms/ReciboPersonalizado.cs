...
{
    public partial class ReciboPersonalizado : Form
    {
        public ReciboPersonalizado()
        {
            InitializeComponent();
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    ReciboPerso frm = new ReciboPerso(nome.Text, cod.Text, cep.Text, uf.Text, cidade.Text, endereco.Text, numero.Text, bairro.Text, servico.Text, valor.Text, valorExt.Text, mesRef.Text, dataPgto.Text);
                frm.Show();
            }
...
| valor_por_extenso.Substring(valor_por_extenso.Length - 8, 7) == "Trihlões")
        ...
        private void MesRef_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
        ...
        private void ReciboPersonalizado_Load(object sender, EventArgs e)
        {
